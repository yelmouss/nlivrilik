...
export async function middleware(req) {
  ...
  if ((req.nextUrl.pathname.startsWith('/my-orders') || 
       req.nextUrl.pathname.startsWith('/order')) && !isAuthenticated) {
...
export const config = {
  matcher: ['/my-orders/:path*', '/order/:path*', '/admin/:path*', '/auth/signin', '/auth/signup'],
};
