...
// Item pour le livreur
const deliveryItem = {
  labelKey: "DeliveryDashboard",
  href: "/delivery",
...
export default function Navbar() {
  ...
  const isDeliveryMan =
    isAuthenticated && session.user.role === UserRoles.DELIVERY_MAN;
  ...
  const drawer = (
    <Box
      ...
      sx={{
        textAlign: "center",
        width: 250,
        backgroundColor: theme.palette.custom.darkTeal,
        height: "100%",
      }}
      role="presentation"
    >
      ...
      <List>
        ...
        {isDeliveryMan && (
          <ListItem key={deliveryItem.labelKey} disablePadding>
            <ListItemButton
              component={Link}
              href={deliveryItem.href}
              sx={{ pl: 2 }}
            >
              <ListItemIcon
                sx={{
              ...
              <ListItemText
                primary={t(deliveryItem.labelKey)}
                sx={{ color: theme.palette.custom.lightYellow }}
              />
            </ListItemButton>
          </ListItem>
        ...
        >
          <FormControl sx={{ m: 1, minWidth: "80%" }} size="small">
            <InputLabel
              id="language-select-label-mobile"
              sx={{ color: theme.palette.custom.lightYellow }}
            >
              {t("Language")}
            </InputLabel>
            <Select
              ...
              sx={{
                ...
                "& .MuiOutlinedInput-notchedOutline": {
                  borderColor: theme.palette.custom.lightYellow,
                },
                "& .MuiSvgIcon-root": {
                  color: theme.palette.custom.lightYellow,
                },
